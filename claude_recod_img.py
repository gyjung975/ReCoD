...
def main(args):
    ...
    for idx, target_idx in enumerate(image_ids):
        ...
        for loop in range(args.loop):
            ...
            retrieved_path = os.path.join(args.data_dir, f"train2014/COCO_train2014_{retrieved_image_id:012d}.jpg") if args.dataset == 'okvqa' \
                else os.path.join(args.data_dir, f"train2017/{retrieved_image_id:012d}.jpg")
