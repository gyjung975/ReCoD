...
def main(args):
    ...
    for idx in tqdm(range(0, len(image_ids), args.batch_size)):
        ...
        for loop in range(args.loop):
            ...
            retrieved_path = args.data_dir + f"train2014/COCO_train2014_{retrieved_image_id.item():012d}.jpg" if args.dataset == 'okvqa' \
                else args.data_dir + f"train2017/{retrieved_image_id.item():012d}.jpg"
